...
function employeeApp() {
  ...
  function showAll() {
    ...
    let query = db.query(sql, (err, res) => {
      if (err) throw err;
      console.log(
        "Name  ||  Last Name  ||  Title  ||  Department  ||  Salary  ||  Manager"
      );
      console.log(
        "======================================================================="
      );
    ...
    inquirer
      ...
      .then(function (answer) {
        db.query(
          ...
          { department: answer.chooseDepartment },
          function (err, res) {
            if (err) throw err;
            console.log(
              "Name  ||  Last Name  ||  Title  ||  Department  ||  Salary  ||  Manager"
  ...
  function updateRole() {
    inquirer
      ...
      .then((answers) => {
        ...
        db.query(
          `UPDATE employees SET title = '${answers.getUpdRole}' WHERE name = '${answers.getEmpName}'`,
          (err, res) => {
            if (err) throw err;
            showAll();
          }
  ...
  function updateManager() {
    inquirer
      ...
      .then((answers) => {
        //console.log(answers.getUpdRole + answers.getEmpName);
        db.query(
          `UPDATE employees SET manager = '${answers.getUpdMngr}' WHERE name = '${answers.getEmployeeName}'`,
          (err, res) => {
            if (err) throw err;
            showAll();
          }
  ...
  function updateSalary() {
    inquirer
      ...
      .then((answers) => {
        //console.log(answers.getUpdRole + answers.getEmpName);
        db.query(
          `UPDATE employees SET salary = '${answers.getUpdSalary}' WHERE name = '${answers.getSalaryName}'`,
          (err, res) => {
            if (err) throw err;
            showAll();
          }
